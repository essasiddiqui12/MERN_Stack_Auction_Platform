    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-indigo-900 mb-4">Contact Us</h1>
          <p className="text-lg text-indigo-700">
            Have questions about our auction platform? We're here to help!
          </p>
        </div>
            ...
            <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-8 text-white">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-indigo-100">
                    <p className="text-base font-medium">Email</p>
                    <p className="mt-1">support@zeeshuauction.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-indigo-100">
                    ...
                    <p className="mt-1">123 Auction Lane, Suite 456<br />Bidding City, BC 78901</p>
                  </div>
                </div>
              </div>
